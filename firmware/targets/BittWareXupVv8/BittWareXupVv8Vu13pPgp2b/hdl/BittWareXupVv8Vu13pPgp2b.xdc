...
# add_cells_to_pblock SLR2_GRP  [get_cells -of_objects  [get_pins -hier * -filter {name=~U_Hardware_1/*/GEN_QUAD[4]*}]]
# add_cells_to_pblock SLR2_GRP  [get_cells -of_objects  [get_pins -hier * -filter {name=~U_Hardware_1/*/GEN_QUAD[5]*}]]
# add_cells_to_pblock SLR2_GRP  [get_cells -of_objects  [get_pins -hier * -filter {name=~U_Hardware_1/*/GEN_QUAD[6]*}]]
# add_cells_to_pblock SLR3_GRP  [get_cells -of_objects  [get_pins -hier * -filter {name=~U_Hardware_1/*/GEN_QUAD[7]*}]]

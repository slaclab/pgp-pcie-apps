...
set_property USER_SLR_ASSIGNMENT SLR0 [get_cells {U_Hardware/GEN_VEC[0].U_PrbsLane}]
set_property USER_SLR_ASSIGNMENT SLR0 [get_cells {U_Hardware/GEN_VEC[1].U_PrbsLane}]
set_property USER_SLR_ASSIGNMENT SLR0 [get_cells {U_Hardware/GEN_VEC[2].U_PrbsLane}]
set_property USER_SLR_ASSIGNMENT SLR0 [get_cells {U_Hardware/GEN_VEC[3].U_PrbsLane}]
set_property USER_SLR_ASSIGNMENT SLR2 [get_cells {U_Hardware/GEN_VEC[4].U_PrbsLane}]
set_property USER_SLR_ASSIGNMENT SLR2 [get_cells {U_Hardware/GEN_VEC[5].U_PrbsLane}]
set_property USER_SLR_ASSIGNMENT SLR2 [get_cells {U_Hardware/GEN_VEC[6].U_PrbsLane}]
set_property USER_SLR_ASSIGNMENT SLR2 [get_cells {U_Hardware/GEN_VEC[7].U_PrbsLane}]
